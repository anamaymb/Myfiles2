...
while capture.isOpened():
    ...
    crop_image = frame[1:250, 250:480]

    
    
    # Apply Gaussian blur
    blur = cv2.GaussianBlur(crop_image, (1, 1), 0)
    ...
    mask2 = cv2.inRange(hsv, np.array([92, 82, 85]), np.array([255, 255, 255]))
    ...
    try:
        ...
        for i in range(defects.shape[0]):
            ...
            cv2.circle(crop_image, start, 5, [0, 0, 0], -1)
